...
const RightFeature: React.FC<ButtonProps> = ({ heading, content, img }) => {
  return (
      ...
      <div className="mx-auto max-w-2xl lg:max-w-4xl xl:max-w-7xl px-6 lg:px-8">
        <div className="mx-auto grid grid-cols-1 gap-x-8 gap-y-6 md:gap-y-10 sm:gap-y-20 lg:mx-0 lg:max-w-none lg:grid-cols-2">
          <img
            src={img}
            alt="Group image"
            className="lg:hidden ring-1 ring-gray-400/10 sm:w-[57rem]"
            width={2432}
            height={1442}
          />
          ...
          <img
            src={img}
            alt="Group image"
            className="hidden lg:block w-[48rem] shadow-xl ring-1 ring-gray-400/10"
            width={2432}
            height={1442}
          />
        </div>
